...
assert.equal(startupLifecycleCandidate.qaRefresh.verificationRevision, "v18");
assert.deepEqual(startupLifecycleCandidate.qaEvidence, [
  "design-qa.md",
  "evidence/TAP-0087-r1-v18-remaining-lifecycle.png",
  "evidence/TAP-0087-r1-v18-remaining-workload.png",
]);
...
assert.match(startupLifecycleCandidate.qaRefresh.closureRequires[0], /exact v18 composition/);
