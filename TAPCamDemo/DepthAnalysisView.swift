...
final class DepthAnalysisViewModel: ObservableObject {
    ...
    var displayImage: CGImage {
        ...
        // - Depth shows `TAPDepthVisualizationRenderer.heatmap`, a false-color
        //   view of metric depth samples. It is visual only; measurements use
        //   `TAPMetricDepthMap.samples`.
        // - Mask shows `TAPDepthVisualizationRenderer.validMask`, where white
...
private struct PointCloudPreview: View {
