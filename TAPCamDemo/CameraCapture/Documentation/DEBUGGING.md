...
Metrics include capture, package build, packaging, hook pipeline, write, total
duration, queue wait, pending job count, pairing mode, selected RGB source,
selected depth source, zoom factor, crop mode, and failure reason.
