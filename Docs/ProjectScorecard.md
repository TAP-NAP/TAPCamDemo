...
2. Read [CameraControlsDesign.md](CameraControlsDesign.md) for the accepted
   ...
   ISO/S exposure-priority and manual-focus control lifetime, Settings-owned LiDAR Focus Assist, no-depth fallback, guide
