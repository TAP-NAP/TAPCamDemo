...
is the simulator-safe Locked Camera Capture POC source-contract entry. R4C keeps
...
locked-camera activity type, and requires the App root to use a static diagnostic
