...
struct TAPLockedCameraSessionContentTests {
    ...
    func lockedExtensionLensSelectorUsesAppContextRecordsAndRebuildsSession() throws {
        ...
        #expect(rootSource.contains("controller.openHostApplicationWithExtensionContextURL("))
        #expect(rootSource.contains("extensionContext: extensionContext"))
        ...
        #expect(controllerSource.contains("TAPCam Locked Camera E3B2 Teardown Complete"))
